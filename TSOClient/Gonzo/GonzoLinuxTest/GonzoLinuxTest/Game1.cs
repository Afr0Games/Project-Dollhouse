...
namespace GonzoTest
{
	...
	public class Game1 : Game
	{
		...
		public Game1()
		{
			...
			graphics.PreferredBackBufferWidth = int.Parse(ConfigurationManager.AppSettings["ScreenWidth"]);
			graphics.PreferredBackBufferHeight = int.Parse(ConfigurationManager.AppSettings["ScreenHeight"]);

			Resolution.Init(ref graphics);
			//TODO: Add Global parameter for fullscreen.
			Resolution.SetResolution(int.Parse(ConfigurationManager.AppSettings["ScreenWidth"]), int.Parse(ConfigurationManager.AppSettings["ScreenHeight"]), false);
		...
		{
			StringManager.Initialize(ConfigurationManager.AppSettings["StartupPath"], "gamedata/uitext", "english");
			IsMouseVisible = true;
		...
		protected override void LoadContent()
		{
			...
			FileManager.Initialize(this, ConfigurationManager.AppSettings["StartupPath"]);
		...
		{
			SoundManager = new HitVM(ConfigurationManager.AppSettings["StartupPath"]);
