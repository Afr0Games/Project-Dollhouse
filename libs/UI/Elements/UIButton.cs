...
namespace UI.Elements
{
    ...
    /// </summary>
    public class UIButton : UIElement, IDisposable, IBasicDrawable
    {
        ...
        public UIButton(AddButtonNode Node, ParseResult Result, UIScreen Screen) : base(Screen)
        {
            ...
            if (!Result.State.InSharedPropertiesGroup)
            {
                if (Node.Image != null)
                {
                    ...
                    Position = Node.ButtonPosition + m_Screen.Position;
                }
                else
                {
            ...
            {
                TextColor = (Color)Result.State.TextColor;
                TextColor.A = 255;
            }

            if (Node.TextColorSelected != null)
            {
                TextColorSelected = (Color)Node.TextColorSelected;
                TextColorSelected.A = 255;
            }
            else
            {
                TextColorSelected = (Color)Result.State.TextColorSelected;
                TextColorSelected.A = 255;
            }

            if (Node.TextColorHighlighted != null)
            {
                TextColorHighlighted = (Color)Node.TextColorHighlighted;
                TextColorHighlighted.A = 255;
            }
            else
            {
                TextColorHighlighted = (Color)Result.State.TextColorHighlighted;
                TextColorHighlighted.A = 255;
            }

            if (Node.TextColorDisabled != null)
            {
                TextColorDisabled = (Color)Node.TextColorDisabled;
            }
            else
            {
                TextColorDisabled = (Color)Result.State.TextColorDisabled;
            ...
            if (Visible)
            {
                ...
                if (m_IsTextButton)
                {
                    ...
                    SBatch.DrawString(m_Font, m_Text, m_TextPosition, TextDrawingColor, 0.0f,
                        new Vector2(0.0f, 0.0f), 1.0f, SpriteEffects.None, 0/*Depth + 0.1f*/);
                }
            }
        }
