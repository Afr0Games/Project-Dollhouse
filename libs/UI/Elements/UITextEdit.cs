...
namespace UI.Elements
{
    ...
    public class UITextEdit : UIElement, IDisposable
    {
        ...
        private System.Timers.Timer m_FrameTimer;
        ...
        private System.Timers.Timer m_CursorVisibilityTimer = new System.Timers.Timer();
            ...
            base(Name, TextEditPosition, Size, Screen, Parent)
        {
            ...
            m_CursorVisibilityTimer = new System.Timers.Timer(100);
            ...
            m_FrameTimer = new System.Timers.Timer(500);
            ...
            base(Screen)
        {
            ...
            {
                if (Node.TextEditPosition != null)
                {
                    Position = Node.TextEditPosition;
                    m_TextPosition = Position;
                }
                ...
                if (Node.CursorColor != null)
                    m_CursorColor = (Color)Node.CursorColor;

                if (Node.FrameColor != null)
                    m_FrameColor = (Color)Node.FrameColor;
            }
            else
            {
                if (State.BackColor != null)
                    m_BackColor = (Color)State.BackColor;
                if (State.Color != null)
                    TextColor = (Color)State.Color;
                if (State.CursorColor != null)
                    m_CursorColor = (Color)State.CursorColor;
                if (State.FrameColor != null)
                    m_FrameColor = (Color)State.FrameColor;
                ...
                if(((Vector2)State.Size).X != 0 && ((Vector2)State.Size).Y != 0)
            ...
            m_FrameTimer = new System.Timers.Timer(190);
            m_FrameTimer.Enabled = true;
            m_FrameTimer.Elapsed += M_FrameTimer_Elapsed;
            m_FrameTimer.Start();
        ...
        public override void Draw(SpriteBatch SBatch)
        {
            ...
            if (m_ScrollbarImage != null)
                SBatch.Draw(m_ScrollbarImage, new Vector2(m_Size.X - m_ScrollbarWidth, 0), null, Color.White, 0.0f,
                    new Vector2(0.0f, 0.0f), new Vector2(0.0f, m_ScrollbarHeight), SpriteEffects.None, 0);
