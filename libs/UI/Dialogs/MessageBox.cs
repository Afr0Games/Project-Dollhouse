...
namespace UI.Dialogs
{
    ...
    public class MessageBox : UIDialog
    {
        ...
        public MessageBox(UIScreen Screen, Vector2 Position, string Message = "", string Title = "", 
            ...
            base(Screen, Position, false, true, true, 255)
        {
            m_Buttons = Buttons;
            this.ZIndex = (int)DrawOrderEnum.MessageBoxes;
            ...
            if (Buttons == MsgBoxButtonEnum.Ok)
            {
                ...
                m_OKButton.ZIndex = this.ZIndex + 1;
            ...
            if(Buttons == MsgBoxButtonEnum.YesNo)
            {
                ...
                m_YesButton.ZIndex = this.ZIndex + 1;
                Children.Add(m_YesButton);
                ...
                m_NoButton.ZIndex = this.ZIndex + 1;
                Children.Add(m_NoButton);
            }
