...
namespace GonzoNet.Encryption
{
    ...
    public class Blowfish : IDisposable
    {
        ...
        /// <summary>
        /// Pads the given data to a multiple of 8.
        /// </summary>
        ...
        public byte[] PadData(byte[] data)
        {
            ...
            int paddingLength = 8 - (dataLength % 8);
            if (paddingLength == 8)
            {
                return data;
            }
            else
            {
                ...
                Array.Copy(data, paddedData, dataLength);

                // Optionally, you can set a specific padding value instead of zeros.
        ...
        /// <summary>
        /// Disposes of the resources used by this Blowfish instance.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        protected virtual void Dispose(bool Disposed)
        {
            if (Disposed)
            {
                ...
                // Prevent the finalizer from calling ~Blowfish, since the object is already disposed at this point.
                GC.SuppressFinalize(this);
            }
            else
                Logger.Log("Blowfish not explicitly disposed!", LogLevel.error);
        }
    }

    public class BlowfishStream : Stream, IDisposable
    {
        ...
        protected virtual async void Dispose(bool Disposed)
        {
            if (Disposed)
            {
                ...
                Logger.Log("BlowfishStream not explicitly disposed!", LogLevel.error);
        }
    }
}